...
//            final double xmi = xmass[i];
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < samples.length; i++) {
            samples[i] = (Double)Randomizer.nextGaussian() * 10 + 0.5; //dist.nextRandom();
        ...
        LogTransformedNormalKDEDistribution ltn = new LogTransformedNormalKDEDistribution(samples, null);
        NormalKDEDistribution nKDE = new NormalKDEDistribution(samples, null);

        if (DEBUG) {
            for (int i = 0; i < 50; i++) {
                //Double test = (Double) dist.nextRandom();
                Double test = (Double)Randomizer.nextGaussian() * 10 + 0.5;
        ...
        for (int i = 0; i < samples.length; i++) {
        	samples[i] = (Double)Randomizer.nextGaussian() * 1.0 + 0.0;
        ...
        ltn = new LogTransformedNormalKDEDistribution(samples, null);
        nKDE = new NormalKDEDistribution(samples, null);
